...
2. **StreamLit**: Read about the StreamLit package and create a StreamLit app about this data (you can leverage ideas from your dashboard)
3. **OPP vs Function**: Take your code and replicate it using an opposite strategy than you have done.
